...
@HiveType(typeId: 3)
class Checklist extends DashboardWidget {
  @HiveField(0)
  late String uuid;
  ...
  static int _getBestMatchIndex(String name) {
    final box = Hive.box<Checklist>('checklistBox');
  ...
  static Checklist? displayChecklistFor(String name) {
  ...
  static Checklist? hideChecklistFor(String name) {
    final bestMatchIndex = _getBestMatchIndex(name);
    if (bestMatchIndex == -1) {
      return null;
    }
